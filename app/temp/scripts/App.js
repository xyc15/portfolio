...
var _ProjectInfo = __webpack_require__(7);
...
var projectInfo = new _ProjectInfo2.default();
// var revealOnScroll = new RevealOnScroll();
new _RevealOnScroll2.default((0, _jquery2.default)(".project-item"), "85%"); //(element, offset)
new _RevealOnScroll2.default((0, _jquery2.default)(".skill"), "80%");
...
//this package is to achieve the scroll effect when clicking navbar links which links to related section.
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    this.siteHeader = (0, _jquery2.default)(".site-header");
    this.headerTriggerElement = (0, _jquery2.default)(".self-intro__title");

    this.createHeaderWaypoint();

    this.pageSections = (0, _jquery2.default)(".page-section");
    this.headerLinks = (0, _jquery2.default)(".navbar a"); //select all header navbar links
        ...
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction == "down") {
              ...
              (0, _jquery2.default)(matchingHeaderLink).addClass("is-current-link"); //this added class will make the link orange, highlight only current section
            }
          },
...
var ProjectInfo = function () {
  function ProjectInfo() {
    ...
    this.infoOpen = (0, _jquery2.default)(".project-item__info-open");
    this.infoClose = (0, _jquery2.default)(".project-item__info-close");
    this.projectImage = (0, _jquery2.default)(".project-item__image");
  ...
  _createClass(ProjectInfo, [{
    ...
    value: function showInfo() {
      this.infoOpen.click(function () {
        (0, _jquery2.default)(this).parents(".project-item__intro").addClass("project-item--is-hidden");
        (0, _jquery2.default)(this).parents(".project-item").children(".project-item__info").addClass("project-item--is-visible");
      });
    ...
    value: function hideInfo() {
      this.infoClose.click(function () {
        (0, _jquery2.default)(this).parents(".project-item__info").removeClass("project-item--is-visible");
        (0, _jquery2.default)(this).parents(".project-item").children(".project-item__intro").removeClass("project-item--is-hidden");
      });
    }
  }]);
